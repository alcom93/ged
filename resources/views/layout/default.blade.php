...
<body>
    <nav class="navbar">
        <div class="container-fluid">
            <a class="navbar-brandmb-0 h3 style="margin:35px 0 ; "9" href="{{ route('homepage') }}">NASSIF SOFTSass v1.0</a>
                ...
                @auth
                    ...
                    <form class="mb-0" action="{{ route('logout-action') }}" method="post">
                        ...
                        <button class="btn btn-link text-info">
                            <img src="{{ asset('img/images (2).png') }}" alt="Logout"
                                style="width: 30px; height: 30px;margin-right: 5px"> log out</button>
                    </form>
                @endauth
            </div>
        </div>
